...
# ==================== Standard PPM Pyramid Pooling Module ====================
class PPM(nn.Module):
...
# ==================== Standard UperNet (Bug-Free Version) ====================
...
# ==================== Test (must add model.eval()) ====================
if __name__ == "__main__":
    model = UperNet(num_classes=6, in_channels=3)
    model.eval()  # Disable BatchNorm training mode to resolve errors!
